...
import { Lock, ArrowRight, ArrowLeft, AlertCircle, Loader2, CheckCircle2 } from "lucide-react";
          ...
          {success ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                ...
                <div className="space-y-1.5">
                  <label htmlFor="confirm-password" className="block text-xs font-medium uppercase tracking-wider text-muted">
                    Confirm Password
                  </label>
                  <div className="relative">
                    <Lock className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted" />
