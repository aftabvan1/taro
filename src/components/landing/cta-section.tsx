  ...
  return (
    <Section withGrid>
      <motion.div
        ...
        className="relative overflow-hidden rounded-3xl border border-white/[0.06] bg-white/[0.02] px-8 py-24 text-center backdrop-blur-sm"
      >
        {/* Background glow */}
        ...
        <p className="mx-auto mt-4 max-w-md text-muted">
          Go from zero to a running AI agent in 30 seconds.
